...
# export TORCH_CUDA_ARCH_LIST="6.1;6.2;7.0;7.5;8.0"   # a100: 8.0; v100: 7.0; 2080ti: 7.5; titan xp: 6.1
 export TORCH_CUDA_ARCH_LIST="6.1;6.2;7.0;7.5;8.0;8.6"   # a100: 8.0; v100: 7.0; 2080ti: 7.5; titan xp: 6.1; 4090: 8.9
 sudo apt-get install environment-modules    # 安装module模块
 module purge  # 清空所有软件环境
...
source activate   # 报错IMPORTANT: You may need to close and restart your shell after running 'conda init'.时加上该命令
...
cd /root/autodl-tem/Pointnext/openpoints/cpp/pointnet2_batch
