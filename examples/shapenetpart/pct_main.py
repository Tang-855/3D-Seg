...
def main(gpu, cfg):
   ...
   # print(type(cfg.dataset))
    ...
    '''方法一'''
    try:
        selfprepath = r"/data_1/home/whs/Pointnext/examples/shapenetpart/log/shapenetpart/unsupervised_pct/checkpoint/_ckpt_latest.pth"
    ...
    for epoch in range(cfg.start_epoch, cfg.epochs + 1):
        ...
        save_path = r"log/pictures/pct/wheat_pct_super_40/"
...
def testmetric(model, val_loader, cfg, num_votes=0, data_transform=None):
    ...
    for idx, data in pbar:
       ...
       # data['x'] = get_features_by_keys(data, cfg.feature_keys)
        ...
        leafarr = []
        disarr = []
        predictedpath = "/data/home/whs/Pointnext/examples/shapenetpart/log/visual/pct/wheat_pct_super_40/"  # 保存可视化预测结果的txt的路径
...
if __name__ == "__main__":
    ...
    parser.add_argument('--cfg', type=str, default="../../cfgs/shapenetpart/pct.yaml", help='config file')
